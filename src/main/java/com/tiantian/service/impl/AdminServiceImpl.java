...
import com.tiantian.mapper.AdminMapper;
import com.tiantian.service.AdminService;
import com.tiantian.utils.ExcelUtil;
import com.tiantian.utils.MD5Util;
import com.tiantian.utils.StringUtil;
...
public class AdminServiceImpl implements AdminService {
    ...
    public ResultData login(Admin admin) {
        ...
        return ResultData.ok(dbAdmin);
    }


    @Override
    public ResultData updateAdminStatus(Integer adminStatus, Integer id) {
        Boolean aBoolean = adminMapper.updateAdminStatus(adminStatus, id);
        return ResultData.ok(aBoolean);
    }
...
//        admin.setAdminStatus(1);
     ...
     */
    @Override
    public PageInfo<Admin> list(Integer page, Integer limit) {
        // 添加分页参数
    ...
    public ResultData batchDelete(String[] ids) {
        ...
        if (adminMapper.deleteAdmin(ids)) {
