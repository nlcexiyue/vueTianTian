...
import com.tiantian.mapper.BookMapper;
...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public ResultData updataCondition(Integer bookId, Integer condition) {
        Integer i = bookMapper.updataCondition(bookId, condition);
        if(i!=0){
            return ResultData.ok(true);
        }else{
            return ResultData.error(500,"更新失败");
        }
    }
...
//列表
    @Override
    public PageInfo<Book> list(Integer page, Integer limit) {
