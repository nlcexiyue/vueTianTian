...
public class AuthorController {
    ...
    public ResultData updateAuthorStatus(Integer authorStatus , Integer id){
        return authorService.updateStatus(authorStatus, id);
    }
    ...
    public ResultData list(
        ...
        PageInfo<Author> pageInfo = authorService.list(page,limit);
