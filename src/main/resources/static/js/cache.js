...
layui.use(['form','jquery',"layer"],function() {
    ...
    function showNotice(){
        layer.open({
            ...
            btn: ['春忆，夏别欢，秋莫离，冬逝'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">天微雨，她就像朵莲花，开满我全部的视线</p></pclass></p><p>我打江南走过，\n' +
                '那等在季节里的容颜如莲花的开落，' +
                '东风不来，三月的柳絮不飞，' +
                '你心底如小小的寂寞的城，' +
                '恰若青石的街道向晚 余音不响，' +
                '三月的春帷不揭，' +
                '你底心是小小的窗扉紧掩，' +
                '我是归人。<span class="layui-red"></span></p></div>',
